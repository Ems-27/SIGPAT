			...
			<div class="page-header" width="100%">
             ...
             <div class="row espaco">
				<div class="pull-right">
					<a href="destroir_sessao_seguro_imovel.php"><button type='button' class='btn btn-sm btn-success'>Novo seguro</button></a>
				</div>
			</div>			
			...
			<?php
				if($_SERVER['REQUEST_METHOD']=='POST'){
					...
					<?php }elseif(!isset($_SESSION['ultimo_id'])){	
						...
						$inserir_seguro = "INSERT INTO seguroimovel(apolice_num, data, riscos_cobertos, valor, seguradora) VALUES ('$apolice_num', '$data', '$riscos_cobertos', '$valor', '$seguradora')";
