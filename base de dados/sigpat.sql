...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 18-Mar-2019 às 10:33
...
DROP TABLE IF EXISTS `abate_intangivel`;
...
DROP TABLE IF EXISTS `afectacao`;
...
DROP TABLE IF EXISTS `bemimovel`;
...
DROP TABLE IF EXISTS `bemintangivel`;
...
DROP TABLE IF EXISTS `seguro_imovel`;
...
DROP TABLE IF EXISTS `seguro_movel`;
...
DROP TABLE IF EXISTS `seguro_veiculo`;
